	...
	<div class="main">
		...
		<section>
			...
			<div id="whitepaper" class="coin-whitepaper">
				...
				<ul>
					<!-- <li>
						<a href="http://res.cloudinary.com/dhjjs2uz3/image/upload/v1504232846/KaicoinICO/web/whitepaper_kr.pdf" target="_blank"><img src="http://res.cloudinary.com/dhjjs2uz3/image/upload/v1504250602/KaicoinICO/web/flag_kor.png" width="85" height="130" alt="한국어" /></a>
					</li> -->
					<li>
						<a href="http://res.cloudinary.com/dhjjs2uz3/image/upload/v1506652560/KaicoinICO/web/whitepaper_en.pdf" target="_blank"><img src="http://res.cloudinary.com/dhjjs2uz3/image/upload/v1504250602/KaicoinICO/web/flag_eng.png" width="85" height="130" alt="English" /></a>
					</li>
					<li>
						<a href="http://res.cloudinary.com/dhjjs2uz3/image/upload/v1506652571/KaicoinICO/web/whitepaper_ja.pdf" target="_blank"><img src="http://res.cloudinary.com/dhjjs2uz3/image/upload/v1504250602/KaicoinICO/web/flag_jap.png" width="85" height="127" alt="日本語" /></a>
					</li>
					<li>
						<a href="http://res.cloudinary.com/dhjjs2uz3/image/upload/v1506652560/KaicoinICO/web/whitepaper_ch.pdf" target="_blank"><img src="http://res.cloudinary.com/dhjjs2uz3/image/upload/v1504250602/KaicoinICO/web/flag_chn.png" width="85" height="130" alt="中文" /></a>
					</li>
					<li>
						<a href="http://res.cloudinary.com/dhjjs2uz3/image/upload/v1504251123/KaicoinICO/web/whitepaper_es.pdf" target="_blank"><img src="http://res.cloudinary.com/dhjjs2uz3/image/upload/v1504250602/KaicoinICO/web/flag_esp.png" width="85" height="130" alt="Español" /></a>
					</li>
					<li>
						<a href="http://res.cloudinary.com/dhjjs2uz3/image/upload/v1506652579/KaicoinICO/web/whitepaper_ph.pdf" target="_blank"><img src="http://res.cloudinary.com/dhjjs2uz3/image/upload/v1505351091/KaicoinICO/web/flag_phl.png" width="85" height="131" alt="Tagalog" /></a>
					</li>
				</ul>
			</div>
			<div class="partners">
				...
				<ul class="list-partners">
					...
					<li v-html="$t('main.partners-content13')"></li>
					<li v-html="$t('main.partners-content14')"></li>
					<li v-html="$t('main.partners-content15')"></li>
					<li v-html="$t('main.partners-content16')"></li>
				</ul>
			</div>
		</section>

		<div class="warning-popup">
			<img src="http://res.cloudinary.com/dhjjs2uz3/image/upload/v1504747117/KaicoinICO/web/warning-popup.png" alt="" />
			<a href="#" class="warning-popup-close">Close</a>
		</div>
	</div>
</template>
...
<script>
	export default {
		...
		mounted: function () {
			...
			$('.warning-popup-close').on('click', function(e) {
				e.preventDefault();
				$('.warning-popup').hide();
			})
		},
		...
		methods: {
			...
			faq: function() {
				$('.coin-faq dt a').on('click touch', function(e) {
					e.preventDefault();
