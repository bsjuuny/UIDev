	...
	export default {
		...
		methods: {
				...
				var settings = {
					...
					success : function(data, status, response) {
						if (data.ethereumAddr) {
							...
							$('.ico-investment-application-form .ehterium-wallet').html('<a href="https://etherscan.io/address/'+this.ethAddress.toLowerCase()+'" target="_blank">https://etherscan.io/address/'+this.ethAddress.toLowerCase()+'</a>')
			...
			icoParticipated: function() {
				...
				$('.ico-investment-application-form .ehterium-wallet').html('<a href="https://etherscan.io/address/'+getEtheriumAddress+'" target="_blank">https://etherscan.io/address/'+getEtheriumAddress+'</a>')
			}
		}
	}
</script>