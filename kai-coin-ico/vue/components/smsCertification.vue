<template>
	<section class="section-join">
		...
		<div class="selectbox-parent send-sms">
			<a href="#" class="design-selectbox" v-html="$t('join.join-country-republicofkorea')"></a>
			...
			<select name="" id="" class="select-national">
				<option value="1" v-html="$t('join.join-country-canada')"></option>
				<option value="7" v-html="$t('join.join-country-russia')"></option>
				<option value="20" v-html="$t('join.join-country-egypt')"></option>
				<option value="27" v-html="$t('join.join-country-republicofsouthafrica')"></option>
				<option value="31" v-html="$t('join.join-country-netherlands')"></option>
				<option value="33" v-html="$t('join.join-country-france')"></option>
				<option value="34" v-html="$t('join.join-country-spain')"></option>
				<option value="39" v-html="$t('join.join-country-italy')"></option>
				<option value="41" v-html="$t('join.join-country-switzerland')"></option>
				<option value="44" v-html="$t('join.join-country-unitedkingdom')"></option>
				<option value="48" v-html="$t('join.join-country-poland')"></option>
				<option value="49" v-html="$t('join.join-country-germany')"></option>
				<option value="51" v-html="$t('join.join-country-peru')"></option>
				<option value="52" v-html="$t('join.join-country-mexico')"></option>
				<option value="54" v-html="$t('join.join-country-argentina')"></option>
				<option value="55" v-html="$t('join.join-country-brazil')"></option>
				<option value="56" v-html="$t('join.join-country-chile')"></option>
				<option value="57" v-html="$t('join.join-country-columbia')"></option>
				<option value="60" v-html="$t('join.join-country-malaysia')"></option>
				<option value="61" v-html="$t('join.join-country-australia')"></option>
				<option value="63" v-html="$t('join.join-country-philippines')"></option>
				<option value="64" v-html="$t('join.join-country-newzealand')"></option>
				<option value="65" v-html="$t('join.join-country-singapore')"></option>
				<option value="66" v-html="$t('join.join-country-thailand')"></option>
				<option value="81" v-html="$t('join.join-country-japan')"></option>
				<option value="82" selected="selected" v-html="$t('join.join-country-republicofkorea')"></option>
				<option value="84" v-html="$t('join.join-country-vietnam')"></option>
				<option value="86" v-html="$t('join.join-country-china')"></option>
				<option value="90" v-html="$t('join.join-country-turkey')"></option>
				<option value="98" v-html="$t('join.join-country-iran')"></option>
	...
	export default {
		...
		methods: {
			...
			validatePhone: function() {
				this.selectedCountry = $('.select-national option:selected').val();
				if (this.selectedCountry == 82) {
